...
INSERT INTO bundles VALUES('camping', 10, 
                            ...
                            50,75,100,125,150,
                            'C:\Users\tonim\Documents\CSCI 4300\rentasport\dbpics\camp.jpg');
INSERT INTO bundles VALUES('soccer', 8, 
                            'soccer ball, cones, clones, field goal',
                            50,75,100,125,150, 
                            'C:\Users\tonim\Documents\CSCI 4300\rentasport\dbpics\soccer.jpg');
INSERT INTO bundles VALUES('football', 13, 
                            'football, flags, knee pads',
                            50,75,100,125,150,
                            'C:\Users\tonim\Documents\CSCI 4300\rentasport\dbpics\football.jpg');
INSERT INTO bundles VALUES('baseball', 10, 
                            'baseball, bat, gloves',
                            50,75,100,125,150,
                            'C:\Users\tonim\Documents\CSCI 4300\rentasport\dbpics\baseball.png');
INSERT INTO bundles VALUES('volleyball', 10, 
                            'volleyball, knee pads',
                            50,75,100,125,150,
                           'C:\Users\tonim\Documents\CSCI 4300\rentasport\dbpics\volleyball.jpg');
...
INSERT INTO cart VALUES((select customerId from user where name = 'Jane Doe'),(select orderNum from orders JOIN user ON user.customerId=orders.customerId where user.name= 'Jane Doe' and orders.orderStatus= 'open'), 'camping', 2);

INSERT INTO cart VALUES((select customerId from user where name = 'Jane Doe'),(select orderNum from orders JOIN user ON user.customerId=orders.customerId where user.name= 'Jane Doe' and orders.orderStatus= 'open'), 'football', 1);