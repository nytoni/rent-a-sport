...
public class UserPersister {
 ...
 public static ResultSet getCart(String time, String bundleName){
	 String idQuery = "select "+time +" from bundles where bundleName = '"+bundleName+"';";
	 return DbAccessImpl.retrieve(con, idQuery);
 }//getcart
  
 public static ResultSet getCartInfo(int userId){
	 String idQuery ="select quantity, bundleName, timePeriod from cart where customerId ='1001' AND orderNum IS NULL;";
	 return DbAccessImpl.retrieve(con, idQuery);
 }//getCartInfo
 ...
 public static void removeBundleFromCart(String bundleName, int userId){
  ...
  public static ResultSet getCartInfoForOrder(int userId){
